...
# Running on matrix JRC EMO
# Zoom on Occitanie
# Here the model works with day-varying temperature (but not used :())
...
if (file.exists("C:/Users/2024ar003/Desktop/Alcuni file permanenti/Post_doc/Codice/local.R")){
  folder_EMO = "C:/Users/2024ar003/Desktop/Alcuni file permanenti/Post_doc/Dati/EMO-JRC_elab"
  folder_out = "C:/Users/2024ar003/Desktop/Alcuni file permanenti/Post_doc/Dati/EMO-JRC_sim"
} else {
  folder_EMO = "EMO-JRC_elab"
  folder_out = "EMO-JRC_sim"
}

dir.create(folder_out)

#Getting weather from EMO
load(paste0(folder_EMO, "/EMO-JRC_sel_", years[1], "_Occitanie_EMO.RData")) #EMO 
...
for (year in years){
  ...
  #getting weather from EMO <- previous year
  load(paste0(folder_EMO, "/EMO-JRC_sel_", year-1, "_Occitanie_EMO.RData"))
  ...
  #Getting weather from EMO
  load(paste0(folder_EMO, "/EMO-JRC_sel_", years[1], "_Occitanie_EMO.RData"))
  ...
  # Here I had to replace T_m with T_av
